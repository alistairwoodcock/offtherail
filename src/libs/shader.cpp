...
namespace ShaderMaps{
	...
	// -- Public --
	// Role: Test if an index has an associated key in the Shader map
	//
	...
	// -- Public --
	// Role: Set the value at a given key in the shader map 
	//
	...
	// -- Public --
	// Role: Test if a given key is in the shader map
	//
	...
	// -- Public --
	// Role: Retrieve a shader given a key
	//
	...
	// -- Public --
	// Role: Set callback value for a given element in the shader map
	//
...
namespace Shaders{
	...
	// -- Public --
	// Role: Setup the shader environment
	//
	void setup(){
		printf("setup Shader\n");
		...
		for(int i = 0; i < game->shaderMap->count; i++){
			...
			if(shader.vsFileName.length() > 0 && shader.fsFileName.length() > 0 && shader.name.length() > 0)
			{
				...
				// Add shader into the shader map
	...
	// -- Public --
	// Role: Reloads shader dynamically
	//
	void update(){
		/*
	...
	// -- Public --
	// Role: Get a shader given its name 
	//
	...
	// -- Public --
	// Role: Reload the callbacks for all shaders 
	//
